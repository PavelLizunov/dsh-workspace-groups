window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function WorkspaceRow({ node, t, onToggle, onNewSession, onRename, onDelete, hasOverride = false, onMoveOut, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartExtra }) {
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
			const menuItems = [
				...hasOverride && onMoveOut !== void 0 ? [{
					id: "moveOut",
