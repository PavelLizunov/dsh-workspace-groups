		...
		*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(manageable || onDragStartCategory !== void 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [onDragStartCategory !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							role: "button",
							tabIndex: 0,
		...
		function WorkspaceRow({ node, t, onToggle, onNewSession, onRename, onDelete, canMoveOut = false, onMoveOut, moveTargets, onMoveTo, flat = false, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartExtra }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				draggable: onDragStartExtra !== void 0 || onRowDrop !== void 0,
				onClick: onToggle,
				onKeyDown: onToggle === void 0 ? void 0 : handleKeyDown,
				onDragStart: onDragStartExtra !== void 0 || onRowDrop !== void 0 ? onDragStart : void 0,
				onDragOver: onRowDragOver,
				onDragLeave: onRowDragLeave,
				onDrop: onRowDrop,
				children: [
					...
					(menuItems.length > 0 || onNewSession !== void 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: "wgRowActions",
						children: [menuItems.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
							open: menuOpen,
							onClose: () => {
								setMenuOpen(false);
							},
		...
		function SessionRow({ node, currentId, now, t, onOpen, onRename, onFork, onArchive, actionBusy = false }) {
			...
			const moveWorkspaceTo = async (workspaceId, categoryKey, beforeWorkspaceId, afterWorkspaceId) => {
				...
				try {
					...
					if (categoryKey === UNCATEGORIZED_KEY) {
						...
						if (movingAcross) {
							if (currentKey !== void 0 && workspaceOrder[currentKey] !== void 0) workspaceOrder[currentKey] = workspaceOrder[currentKey].filter((id) => id !== workspaceId);
							if (workspaceOrder["__topLevel__"] !== void 0) workspaceOrder[TOP_LEVEL_ORDER_KEY] = workspaceOrder[TOP_LEVEL_ORDER_KEY].filter((id) => id !== workspaceId);
						}
						next = {
							...manual,
							assignments,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [wide && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
