		...
		*/
		...
		function SidebarFilterMenu({ filter, onChange, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				onSelect: (id) => {
					if (id === "filter:reset") onChange(DEFAULT_SIDEBAR_FILTER);
							...
							normalizedQuery !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SearchBody, {
								...
								children: [
									...
									(displayTopLevel.length > 0 || topLevelDropActive) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TopLevelSection, {
										...
										onDropRow,
										onDragStartWorkspace,
										...!isFilterActive ? { onToggleWorkspace: (key) => {
											actions.setWorkspaceExpanded(key, !workspaceExpansion[key]);
										} } : {},
										onNewSession: startSession,
										onOpen: open,
		...
		function CategorySection({ category, categoryIndex, totalRootItems, current, now, t, dragIndicator, onDragOverRow, onDragLeaveRow, onDropRow, onDragStartCategory, onDragStartWorkspace, onToggleCategory, onToggleWorkspace, onNewSession, onOpen, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onFork, sessionActionBusy, onGroupRename, onGroupDelete, onMoveOut, onMoveTo, moveTargetsFor, canMoveOut, onMoveGroupUp, onMoveGroupDown, onMoveWorkspaceUp, onMoveWorkspaceDown, onOpenFolder, onCopyPath, isFirstGroup, isLastGroup, manual, onSetItemColor }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CategoryRow, {
					...
					...onToggleCategory === void 0 ? {} : { onToggle: onToggleCategory },
					...
					children: category.workspaces.map((workspace, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WorkspaceRow, {
							...
							...onToggleWorkspace === void 0 ? {} : { onToggle: () => {
