window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function CategoryRow({ node, t, onToggle, onRename, onDelete, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartCategory, onMoveUp, onMoveDown, isFirst, isLast, canMoveUp, canMoveDown, "aria-level": ariaLevel, "aria-posinset": ariaPosinset, "aria-setsize": ariaSetsize }) {
		...
		function WorkspaceRow({ node, t, onToggle, onNewSession, onRename, onDelete, canMoveOut = false, onMoveOut, moveTargets, onMoveTo, onMoveUp, onMoveDown, onOpenFolder, onCopyPath, isFirst, isLast, canMoveUp, canMoveDown, flat = false, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartExtra, "aria-level": ariaLevel, "aria-posinset": ariaPosinset, "aria-setsize": ariaSetsize }) {
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
			const menuItems = [
				...onMoveUp !== void 0 ? [{
					id: "moveUp",
						...
						children: [
							...
							normalizedQuery !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SearchBody, {
								...
								children: [
									...
									groups.map((category, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CategorySection, {
										category,
										categoryIndex: idx,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CategoryRow, {
					...
					children: category.workspaces.map((workspace, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), workspace.expanded && workspace.sessions.map((session, sIdx) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionRow, {
							node: session,
							currentId: current,
							now,
							t,
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CategoryRow, {
							...
							children: category.workspaces.map((workspace, wIdx) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WorkspaceRow, {
									...
									role: "group",
									children: workspace.sessions.map((session, sIdx) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionRow, {
										node: session,
										currentId: current,
										now,
										t,
