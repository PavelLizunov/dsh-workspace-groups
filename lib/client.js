window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function CategoryRow({ node, t, onToggle, onRename, onDelete, color, onSetColor, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartCategory, onMoveUp, onMoveDown, isFirst, isLast, canMoveUp, canMoveDown, "aria-level": ariaLevel, "aria-posinset": ariaPosinset, "aria-setsize": ariaSetsize }) {
						...
						children: [onDragStartCategory !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							onSelect: (id) => {
								...
								if (id.startsWith("color:")) {
									const selectedColor = id.slice(6);
		...
		function WorkspaceRow({ node, t, onToggle, onNewSession, onRename, onDelete, color, onSetColor, canMoveOut = false, onMoveOut, moveTargets, onMoveTo, onMoveUp, onMoveDown, onOpenFolder, onCopyPath, isFirst, isLast, canMoveUp, canMoveDown, flat = false, dropActive = false, insertLine, onRowDragOver, onRowDragLeave, onRowDrop, onDragStartExtra, "aria-level": ariaLevel, "aria-posinset": ariaPosinset, "aria-setsize": ariaSetsize }) {
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
			const menuItems = [
				...onMoveUp !== void 0 ? [{
					id: "moveUp",
